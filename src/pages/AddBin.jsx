      ...
      <form className="container lg:px-64 lg:py-12">
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
          ...
          <div class="relative z-0 mb-6 w-full group">
            ...
            <label for="floating_phone" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Phone number (optional)</label>
          </div>
          ...
          <div>
            <label for="default-toggle" class="inline-flex relative items-center cursor-pointer">
              ...
              <span class="ml-3 text-sm font-medium text-gray-900 ">Get Updates via Email.</span>
            </label>
          </div>
        </div>
